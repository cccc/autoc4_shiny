...
declare global {
	...
	namespace Paho {
		 ...
		 * @param message The {@link Paho.Message} that was delivered or has arrived.
		 */
		...
		class Client {
			...
			/**
			 * called when a message has arrived in this Paho.client.
			 ...
			 *
			 * @param message - <b>mandatory</b> The {@link Paho.Message} object to be sent.
